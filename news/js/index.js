...
function renderLatestNews() {
  getArticles().then((res) => {
    ...
    data.forEach((item, idx) => {
      if (idx <= 1) {
        htmlPrimary += renderLatestNewsPrimaryItem(item);
      } else if (idx <= 3 && idx > 1) {
        htmlSecondary += renderLatestNewsSecondaryItem(item);
      } else {
...
function renderLatestNewsPrimaryItem(data) {
  return `
  <div class="col-lg-6">
    <div class="position-relative mb-3">
        ...
        <div class="bg-white border border-top-0 p-4">
            ...
            <a class="h4 d-block mb-3 text-secondary text-uppercase font-weight-bold title"
                href="">${data.title}</a>
            <p class="m-0 desc">${data.description}</p>
        </div>
...
function renderLatestNewsSecondaryItem(data) {
  return `
  <div class="col-lg-6 ">
    <div class="position-relative mb-3">
        ...
        <div class="bg-white border border-top-0 p-4">
            ...
            <a class="h4 d-block mb-0 text-secondary text-uppercase font-weight-bold title"
                href="">${data.title}</a>
        </div>
        <div class="d-flex justify-content-between bg-white border border-top-0 p-4">
            <div class="d-flex align-items-center">
